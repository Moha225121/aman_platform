...
<body>
    <header class="site-header">
        <div class="container nav-wrap">
            <a class="brand" href="#top" aria-label="أمان - الصفحة الرئيسية">
                <img class="brand-logo" src="{{ asset('images/aman/logo.png') }}" alt="شعار منصة أمان"><span><strong>أمان</strong><small>SAVE</small></span>
            </a>
    ...
    <footer><div class="container footer-grid"><div class="brand footer-brand"><img class="brand-logo" src="{{ asset('images/aman/logo.png') }}" alt="شعار أمان"><span><strong>أمان</strong><small>SAVE</small></span></div><p>الفهم بداية التغيير</p><div><a href="#services">الخدمات</a><a href="#programs">البرامج</a><button class="footer-policy policy-trigger">سياسة الخصوصية والأمان</button></div><small>© {{ date('Y') }} منصة أمان. جميع الحقوق محفوظة.</small></div></footer>
