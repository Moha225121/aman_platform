...
<body>
    ...
    <footer><div class="container footer-grid"><div class="brand footer-brand"><img class="brand-logo" src="{{ asset('images/aman/logo.png') }}" alt="شعار أمان"><span><strong>أمان</strong><small>SAFETY</small></span></div><p>الفهم بداية التغيير</p><div><a href="#services">الخدمات</a><a href="#programs">البرامج</a><button class="footer-policy policy-trigger">سياسة الخصوصية والأمان</button></div><small>© {{ date('Y') }} منصة أمان. جميع الحقوق محفوظة.</small><p class="footer-developer">طُوّر من قبل <span dir="ltr">HEXA.Tech</span> — التقنية السداسية</p></div></footer>
